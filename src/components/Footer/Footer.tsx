	...
	<div className={styles.footer}>
		<div className={styles.footer_top}>
			<div className={classNames(styles.secret_buyer, styles.container)}>
				...
				<div className={styles.secret_text}>
					Стань тайным покупателем Додо Пиццы и получи пиццу в подарок
				</div>
				<a href='https://dodocontrol.ru' className={styles.secret_button}>
					Заполнить анкету
				</a>
			</div>
		</div>
		<div>
			<div className={classNames(styles.menu, styles.container)}>
				<div className={styles.navigation}>
					<div className={styles.links__section}>
						...
						<a href='#root' className={styles.links__section_link}>
							О нас
						</a>
						<a href='#root' className={styles.links__section_link}>
							Додо-книга
					...
					<div className={styles.contacts}>
						<div className={styles.contacts_phone}>
							<div className={styles.contacts_phone_description}>
								<span className={styles.contacts_phone_description__text}>
									Звонок бесплатный
								</span>
							</div>
							<div className={styles.contacts_phone_number}>
								<a href='#root' className={styles.contacts_phone_number__link}>
									+998712077729
								</a>
							</div>
						</div>
						<a href='#root' className={styles.contacts_adress}>
			...
			<div className={classNames(styles.statistics, styles.container)}>
				<div className={styles.stats_part}>
					...
					<span className={styles.stats_more}>
				...
				<div className={styles.stats_part}>
					...
					<span className={styles.stats_more}>
						в 16 странах, от Великобритании до Нигерии
					</span>
				</div>
			</div>
			<div className={classNames(styles.footer_copyright, styles.container)}>
				...
				<div className={styles.bottom_links}>
					<a href='#root' className={styles.bottom_link}>
						Правовая информация
					</a>
				</div>
				<div className={styles.social_links}>
					<a href='#root' className={styles.social_link}>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 140 140'>
							<path
								...
								d='M29.56,24.55a5,5,0,0,0-5,5v80.88a5,5,0,0,0,5,5H73.1V80.26H61.25V66.53H73.1V56.41c0-11.74,7.17-18.13,17.65-18.13a97.08,97.08,0,0,1,10.58.54V51.09H94.07c-5.7,0-6.8,2.71-6.8,6.68v8.76h13.59L99.08,80.26H87.27v35.2h23.17a5,5,0,0,0,5-5V29.56a5,5,0,0,0-5-5H29.56Z'
							>
								{' '}
							</path>
						</svg>
					...
					<a href='#root' className={styles.social_link}>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 140 140'>
							<path
								className={styles.social_img}
								d='M70,30.36c-22.31,0-44.61,1.71-49.51,5.12-9.8,6.83-9.8,62.19,0,69s89.22,6.83,99,0,9.8-62.19,0-69c-4.9-3.42-27.21-5.12-49.51-5.12h0ZM58.69,53.43L87.39,70,58.69,86.57V53.43Z'
							>
								{' '}
							</path>
						</svg>
